...
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO DARK WOLF  TOOLS  \e[m "
echo
...
echo "
        ...
        WELCOME TO DARK-WOLF TOOLS_-^^DARK-WOLF-HACKING^^-_ JOIN ON MY TELEGRAM CHANNEL
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY DARK-WOLF\e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please JOIN OUR TELEGRAM CHANNEL FOR NEW COMMAND ! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    Join my telegram channel for hacking and cyber security tutorials,ok?
...
tput clear
tput cup 3 30
echo -e "\e[44m Like \e[41m JOIN \e[m"
tput cup 6 30
echo -e "\x1b[42m DARK-WOLF-HACKING \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have YOU JOIN MY TELEGRAM CHANNEL (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou for JOINING my channel \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m JOIN  my channel for hacking tutorial \x1b[m"
fi
tput cup 20 0
figlet -f slant "DARK-WOLF-HACKING YOU KNOW " |lolcat
echo " "
echo " "
#done setting up
